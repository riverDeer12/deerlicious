...
namespace Deerlicious.API.Database.Migrations
{
    ...
    [Migration("20250121115901_AddedTemporalTables00")]
    partial class AddedTemporalTables00
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Deerlicious.API.Database.Entities.Administrator", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f36600a4-80b3-459e-967c-19da01f16df6"),
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 1, 21, 12, 59, 1, 581, DateTimeKind.Unspecified).AddTicks(3490), new TimeSpan(0, 1, 0, 0, 0)),
                            CreatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            FirstName = "Super",
                            IsDeleted = false,
                            LastName = "Admin",
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 1, 21, 12, 59, 1, 581, DateTimeKind.Unspecified).AddTicks(3490), new TimeSpan(0, 1, 0, 0, 0)),
            ...
            modelBuilder.Entity("Deerlicious.API.Database.Entities.Recipe", b =>
                {
                    ...
                    b.ToTable(tb => tb.IsTemporal(ttb =>
                            {
                                ttb.UseHistoryTable("RecipesHistory");
                                ttb
                                    .HasPeriodStart("PeriodStart")
                                    .HasColumnName("PeriodStart");
                                ttb
            ...
            modelBuilder.Entity("Deerlicious.API.Database.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 1, 21, 12, 59, 1, 581, DateTimeKind.Unspecified).AddTicks(3430), new TimeSpan(0, 1, 0, 0, 0)),
                            CreatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            Description = "Role with all access.",
                            IsDeleted = false,
                            Name = "SuperAdmin",
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 1, 21, 12, 59, 1, 581, DateTimeKind.Unspecified).AddTicks(3440), new TimeSpan(0, 1, 0, 0, 0)),
                            UpdatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb")
                        });
                });
            ...
            modelBuilder.Entity("Deerlicious.API.Database.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 1, 21, 12, 59, 1, 581, DateTimeKind.Unspecified).AddTicks(3000), new TimeSpan(0, 1, 0, 0, 0)),
                            CreatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 1, 21, 12, 59, 1, 581, DateTimeKind.Unspecified).AddTicks(3040), new TimeSpan(0, 1, 0, 0, 0)),
                            UpdatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            UserName = "superadmin"
                        });
                });
